...
#define ST7789_DC_PORT  ST_DC_GPIO_Port
#define ST7789_DC_PIN   ST_DC_Pin

#ifndef CFG_NO_CS
#define ST7789_CS_PORT  ST_CS_GPIO_Port
#define ST7789_CS_PIN   ST_CS_Pin
#endif
...
void ST7789_DrawRectangle(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color, uint16_t thickness);

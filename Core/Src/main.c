...
void WS2812_VIEW_Update(void) {
  ...
  switch (DPO_FE.TRIG_MODE)
  {
  case TRIGMODE_AUTO:
    WS2812_Write_Data(THEME_TRIGMODE.WAKE, LED_DOWN_R);
    WS2812_Write_Data(THEME_TRIGMODE.WAKE, LED_DOWN_M);
    WS2812_Write_Data(THEME_TRIGMODE.WAKE, LED_DOWN_L);  

    WS2812_Write_Data(THEME_TRIGMODE.WAKE, LED_RUN_STOP);  
    WS2812_Write_Data(THEME_TRIGMODE.WAKE, LED_SINGLE);  

      break;
  case TRIGMODE_SINGLE:
    WS2812_Write_Data(THEME_TRIGMODE.MAIN, LED_DOWN_R);
    WS2812_Write_Data(THEME_TRIGMODE.MAIN, LED_DOWN_M);
    WS2812_Write_Data(THEME_TRIGMODE.MAIN, LED_DOWN_L);  
  ...
  case TRIGMODE_NORMAL:
    ...
    WS2812_Write_Data(THEME_TRIGMODE.WAKE, LED_SINGLE);  
      break;
  case TRIGMODE_STOP:
    WS2812_Write_Data(THEME_TRIGMODE.SHUT, LED_DOWN_R);
    WS2812_Write_Data(THEME_TRIGMODE.SHUT, LED_DOWN_M);
    WS2812_Write_Data(THEME_TRIGMODE.SHUT, LED_DOWN_L);  

    WS2812_Write_Data(THEME_TRIGMODE.SHUT, LED_RUN_STOP);  
    WS2812_Write_Data(THEME_TRIGMODE.SHUT, LED_SINGLE);  
      break;
  ...
  case VIEW_DPO1:
    ...
    WS2812_Write_Data(THEME_DPO_1.MAIN, LED_USB_U);
    WS2812_Write_Data(THEME_DPO_1.MAIN, LED_USB_D);
  break;
  ...
  case VIEW_DPO2:
    ...
    WS2812_Write_Data(THEME_DPO_2.MAIN, LED_USB_U);
    WS2812_Write_Data(THEME_DPO_2.MAIN, LED_USB_D);
    break;
  ...
  case VIEW_AFG1:
    ...
    WS2812_Write_Data(THEME_AFG_1.MAIN, LED_USB_U);
    WS2812_Write_Data(THEME_AFG_1.MAIN, LED_USB_D);
    break;
  ...
  case VIEW_AFG2:
    ...
    WS2812_Write_Data(THEME_AFG_2.MAIN, LED_USB_U);
    WS2812_Write_Data(THEME_AFG_2.MAIN, LED_USB_D);
    break;
  ...
  case VIEW_CONFIG:
    ...
    WS2812_Write_Data(THEME_CONFIG.MAIN, LED_USB_U);
    WS2812_Write_Data(THEME_CONFIG.MAIN, LED_USB_D);
    break;
